...
function getStatsData(articles: Article[], todos: Todo[]) {
  ...
  return { publishedArtiCount, overdueTodosCount, highPriorityCount, rate };
}

export { getArticleAnalytics, getTasksOverTime, getStatsData };
